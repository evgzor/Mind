...
- (CGSize) layoutExpandedGraph
{
	...
	CGFloat parentChildSpacing = 0;//[treeGraph parentChildSpacing];
    ...
    if (subtreeViewCount > 0) {
        ...
        [_connectorsView setHidden:_isConnectorsHidden];
...
-(void)setChildrenSpacing:(NSArray*)spacingList
{
    _spacingList = spacingList;
}
